...
"
SRC_URI="
	https://github.com/python-poetry/poetry/archive/${PV}.tar.gz
		-> ${P}.tar.gz
"
...
# check inside src/poetry/_vendor/vendor.txt
#RDEPEND="
...
#	rm -r poetry/_vendor || die
#	sed -e '/__vendor_site__/d' -i poetry/__init__.py || die
