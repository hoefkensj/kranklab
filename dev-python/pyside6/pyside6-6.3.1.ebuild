...
#https://download.qt.io/official_releases/QtForPython/pyside2/PySide2-${PV}-src/${MY_P}.tar.xz"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6DataVisualization=$(usex !datavis)
		...
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6Script=$(usex !script)
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6ScriptTools=$(usex !scripttools)
		...
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6WebEngine=$(usex !webengine)
		...
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6X11Extras=$(usex !x11extras)
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6Xml=$(usex !xml)
		-DCMAKE_DISABLE_FIND_PACKAGE_Qt6XmlPatterns=$(usex !xmlpatterns)
	)
